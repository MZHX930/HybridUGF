    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        public static TMP_Settings instance
        {
            get
            {
                ...
                {
#if UNITY_EDITOR
                    s_Instance = UnityEditor.AssetDatabase.LoadAssetAtPath<TMP_Settings>("Assets/GameAssets/TMPResources/TMP Settings.asset");
...
#else
                    throw new System.Exception("TMP_Setting Instance Is Null !");
#endif
                }
            ...
            set
            {
                ...
                {
#if !UNITY_EDITOR
                    throw new System.Exception("TMP_Setting Instance Is Not Null!");
#endif
                }
            }
        }
