...
namespace GameDevScript
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            IDataTable<DRDataMusic> dtMusic = GameEntry.DataTable.GetDataTable<DRDataMusic>();
            DRDataMusic drMusic = dtMusic.GetDataRow(musicId);
            if (drMusic == null)
            {
            ...
            s_MusicSerialId = soundComponent.PlaySound(AssetPathUtility.GetMusicAsset(drMusic.AssetName), "Music", Constant.AssetPriority.MusicAsset, playSoundParams, null, userData);
        ...
        {
            IDataTable<DRDataUISound> dtUISound = GameEntry.DataTable.GetDataTable<DRDataUISound>();
            ...
            playSoundParams.SpatialBlend = 0f;
            return soundComponent.PlaySound(AssetPathUtility.GetUISoundAsset(drUISound.AssetName), "UISound", Constant.AssetPriority.UISoundAsset, playSoundParams, userData);
        }
