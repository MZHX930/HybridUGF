...
//         {
//             if (!animator)
//                 animator = this.gameObject.GetComponentInChildren<Animator>();   //尝试从子级GameObject找到一个Animator

//             if (!animator || animInfo == null || animInfo.Count <= 0)
//                 return;
...
//         {
//             if (animInfo.ContainsKey(animName) == false || animator == null)
//                 return;
