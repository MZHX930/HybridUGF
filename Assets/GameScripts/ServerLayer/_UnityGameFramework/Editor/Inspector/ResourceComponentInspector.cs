...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ResourceComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty m_EditorSimulationHttpPath = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_EditorSimulationHttpPath.stringValue = EditorGUILayout.TextField("EditorSimulationHttpPath", m_EditorSimulationHttpPath.stringValue);
#endif
        ...
        private void OnEnable()
        {
            ...
            m_EditorSimulationHttpPath = serializedObject.FindProperty("m_EditorSimulationHttpPath");
