...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class UIComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty m_ObjFullScreenMask = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                EditorGUILayout.PropertyField(m_ObjFullScreenMask);
        ...
        private void OnEnable()
        {
            ...
            m_ObjFullScreenMask = serializedObject.FindProperty("m_ObjFullScreenMask");
