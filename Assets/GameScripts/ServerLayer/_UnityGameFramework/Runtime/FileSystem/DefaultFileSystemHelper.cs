...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultFileSystemHelper : FileSystemHelperBase
    {
        ...
        private const string WebGLFileSystemPrefixString = "http:";
        private const string WebGLFileSystemPrefixString2 = "https:";
        ...
        public override FileSystemStream CreateFileSystemStream(string fullPath, FileSystemAccess access, bool createNew)
        {
            ...
            else if (fullPath.StartsWith(WebGLFileSystemPrefixString, StringComparison.Ordinal)
                || fullPath.StartsWith(WebGLFileSystemPrefixString2, StringComparison.Ordinal))
            {
                return new WebGLFileSystemStream(fullPath, access, createNew);
            }
            else
            {
