...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class LocalizationComponent : GameFrameworkComponent
    {
        ...
        /// 等待切换语言显示
        /// </summary>
        private bool m_NeedNotify = false;
        ...
        private void OnReadDataSuccess(object sender, ReadDataSuccessEventArgs e)
        {
            ...
            if (m_NeedNotify)
                NotifyChangeLanguageAfterReadSuccess();
        }
        ...
        /// 切换游戏语言
        /// </summary>
        public void ChangeGameLanguege(Language newLanguage)
        {
            ...
            RemoveAllRawStrings();
            m_NeedNotify = true;
            string dictionaryAssetName = Utility.Text.Format("Assets/GameDevScript/Localization/{0}/Dictionaries/Default.xml", newLanguage.ToString());
            this.Language = newLanguage;
            ReadData(dictionaryAssetName, this);

            GameEntry.GetComponent<SettingComponent>().SetString("Setting.Language", newLanguage.ToString());
        }

        //读取成功后通知更新语言显示
        private void NotifyChangeLanguageAfterReadSuccess()
        {
            m_NeedNotify = false;
            try
            {
                OnSwitchLanguageEvent?.Invoke();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public delegate void OnSuccessSwitchLanguage();

        public static event OnSuccessSwitchLanguage OnSwitchLanguageEvent;
    }
}
