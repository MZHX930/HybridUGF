...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        private Vector2 m_UIDevelopmentResolution = Vector2.zero;

        [SerializeField]
        private GameObject m_ObjFullScreenMask;
        ...
        /// 设定的UI标准分辨率
        /// </summary>
        public Vector2 UIDevelopmentResolution
        {
            get
            {
                return m_UIDevelopmentResolution;
            }
        }
        ...
        private void Start()
        {
            ...
            CanvasScaler rootScaler = m_InstanceRoot.GetComponent<CanvasScaler>();
            m_UIDevelopmentResolution = (rootScaler == null) ? new Vector2(720, 1456) : rootScaler.referenceResolution;
        ...
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, UIFormData userData)
        {
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, UIFormData userData)
        {
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm, UIFormData userData)
        {
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, UIFormData userData)
        {
        ...
        /// 是否全局遮罩
        /// </summary>
        public void SetFullScreenMask(bool active)
        {
            m_ObjFullScreenMask.SetActive(active);
        }
