...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        [Header("编辑器模式下模拟加载的网址")]
        private string m_EditorSimulationHttpPath = "http://localhost:7457";
#endif
        ...
        private void Start()
        {
            ...
            string readOnlyPath = Application.streamingAssetsPath;
#if UNITY_WEBGL && UNITY_EDITOR
            if (baseComponent.EditorResourceMode)
            {
                readOnlyPath = m_EditorSimulationHttpPath;
            }
#endif
