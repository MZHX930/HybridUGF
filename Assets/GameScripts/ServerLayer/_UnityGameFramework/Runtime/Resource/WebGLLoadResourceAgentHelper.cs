...
namespace UnityGameFramework.Runtime
{
    ...
    public class WebGLLoadResourceAgentHelper : LoadResourceAgentHelperBase, IDisposable
    {
        ...
        private UnityWebRequest m_UnityBundleWebRequest = null;
        ...
        {
            Debug.Log($"gameUpdate ReadFile fullPath={fullPath}");
            ...
            m_UnityBundleWebRequest = UnityWebRequestAssetBundle.GetAssetBundle(fullPath);
            m_UnityBundleWebRequest.SendWebRequest();
        }
        ...
        {
            Debug.Log($"gameUpdate ReadFile fileSystem={fileSystem.FullPath} ; name={name}");
            ...
            m_UnityBundleWebRequest = UnityWebRequestAssetBundle.GetAssetBundle(fileSystem.FullPath, 0u);
            m_UnityBundleWebRequest.SendWebRequest();
        }
        ...
        {
            Debug.Log($"gameUpdate ReadBytes fullPath={fullPath}");
        ...
        {
            Debug.Log($"gameUpdate ReadBytes fileSystem={fileSystem.FullPath} ; name={name}");
        ...
        {
            Debug.Log($"gameUpdate ParseBytes bytes={bytes.Length}");
        ...
        {
            if (m_UnityBundleWebRequest != null)
            {
                if (m_UnityBundleWebRequest.isDone)
                {
                    AssetBundle assetBundle = DownloadHandlerAssetBundle.GetContent(m_UnityBundleWebRequest);
                    if (assetBundle != null)
                    {
                        var oldFileAssetBundleCreateRequest = m_UnityBundleWebRequest;
                        ...
                        if (m_UnityBundleWebRequest == oldFileAssetBundleCreateRequest)
                        {
                            m_UnityBundleWebRequest = null;
                            m_LastProgress = 0f;
                        }
                ...
                else if (m_UnityBundleWebRequest.downloadProgress != m_LastProgress)
                {
                    m_LastProgress = m_UnityBundleWebRequest.downloadProgress;
                    LoadResourceAgentHelperUpdateEventArgs loadResourceAgentHelperUpdateEventArgs = LoadResourceAgentHelperUpdateEventArgs.Create(LoadResourceProgress.LoadResource, m_UnityBundleWebRequest.downloadProgress);
                    m_LoadResourceAgentHelperUpdateEventHandler(this, loadResourceAgentHelperUpdateEventArgs);
                    ReferencePool.Release(loadResourceAgentHelperUpdateEventArgs);
                }
            }
