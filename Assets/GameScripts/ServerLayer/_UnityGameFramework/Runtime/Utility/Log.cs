...
namespace UnityGameFramework.Runtime
{
    ...
    public static class Log
    {
        ...
        {
            GameFrameworkLog.Info($"<color=#ffff00>{message}</color>");
        }
        ...
        {
            GameFrameworkLog.Info($"<color=#ff0000>{message}</color>");
        }
        ...
        {
            GameFrameworkLog.Info($"<color=#00ff00>{message}</color>");
        }
        ...
        [Conditional("ENABLE_INFO_AND_ABOVE_LOG")]
        [Conditional("UNITY_EDITOR")]
        public static void InfoFight(string message)
        {
            GameFrameworkLog.Info($"<color=#FF00FF>FightPhase>>> {message}</color>");
        }
        ...
        public static void ErrorUrl(string content, string scriptAssetsPath, int line)
        {
            string hrefContent = "<a href=\"{0}\" line=\"{1}\">{2}</a>";
            GameFrameworkLog.Error(Utility.Text.Format(hrefContent, scriptAssetsPath.Replace("\\", "/"), line, content));
        }
